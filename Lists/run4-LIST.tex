...
\updateplayer{\cCaptain}{Bernard Arnest} 
\updateplayer{\cCid}{Jessie Lowell}
\updateplayer{\cCidReal}{Jessie Lowell}
\updateplayer{\cCowboy}{Eddy Karat}
\updateplayer{\cCurie}{Ranbel Sun}
\updateplayer{\cDealer}{David Farhi}
\updateplayer{\cJack}{Kristina Brown}
\updateplayer{\cNoble}{James Wnorowski} 
\updateplayer{\cRobot}{Vinayak Ranade} 
\updateplayer{\cSaboteur}{Sukrit Ranjan} 
\updateplayer{\cThief}{Anna Goldie} 
\updateplayer{\cVicar}{Kevin Riggle} 
\updateplayer{\cWolf}{Kevin Riggle}
\updateplayer{\cWhore}{Barbara Short} 
