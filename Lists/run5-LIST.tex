...
\updateplayer{\cCaptain}{Jim Waldrop} 
\updateplayer{\cCid}{Kendra Pugh}
\updateplayer{\cCidReal}{Kendra Pugh}
\updateplayer{\cCowboy}{Diane Christoforo}
\updateplayer{\cCurie}{Yelena Tsitkin}
\updateplayer{\cDealer}{Gareth Williams}
\updateplayer{\cJack}{Jessica McQuaw}
\updateplayer{\cNoble}{mpp} 
\updateplayer{\cRobot}{Jared Turkewitz} 
\updateplayer{\cSaboteur}{Jesse Moeller} 
\updateplayer{\cThief}{Paige Phillips} 
\updateplayer{\cVicar}{Thomas Mack} 
\updateplayer{\cWolf}{Thomas Mack}
\updateplayer{\cWhore}{Jessica McKellar} 
